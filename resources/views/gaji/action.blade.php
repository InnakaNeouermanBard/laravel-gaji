                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="total_gaji">gaji_pokok</label>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.success) {
                    ...
                    const gaji_pokok = data?.data?.absensi?.masuk * data?.data?.gaji
                        ?.gaji_pokok
                    const t_gaji = data?.data?.absensi?.masuk * data?.data?.gaji?.gaji_pokok +
                        t_uang_lembur
